...
figure1 = figure('NumberTitle','off','Name','Energy2');
% Create axes
axes1 = axes('Parent',figure1,'FontSize',18);
box(axes1,'on');
grid(axes1,'on');
...
plot1 = plot(r_energy(2:end_r,1)./r_energy(2:end_r,1),'Parent',axes1,'LineWidth',3);
plot2 = plot(r_energy(2:end_r,7)./r_energy(2:end_r,1),'Parent',axes1,'Linewidth',3);
plot3 = plot(r_energy(2:end_r,4)./r_energy(2:end_r,1),'Parent',axes1,'Linewidth',3);
plot4 = plot(r_energy(2:end_r,5)./r_energy(2:end_r,1),'Parent',axes1,'Linewidth',3);
